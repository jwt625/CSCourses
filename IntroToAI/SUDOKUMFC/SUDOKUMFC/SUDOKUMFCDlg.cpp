...
extern IplImage* imagen, *img;
extern int red,green,blue;
extern IplImage* screenBuffer;
extern int drawing;
extern int r,last_x, last_y;
extern My_OCR ocr;
extern int PictSUDOKU[9][9];
...
void CSUDOKUMFCDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_IMAGEINPUT, m_ImageInput);
	DDX_Control(pDX, IDB_HANDWINPUT, m_HandWInput);
	DDX_Control(pDX, IDB_PICTINPUT, m_PictInput);
}
...
BEGIN_MESSAGE_MAP(CSUDOKUMFCDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_IMAGEINPUT, &CSUDOKUMFCDlg::OnBnClickedImageinput)
	ON_BN_CLICKED(IDB_HANDWINPUT, &CSUDOKUMFCDlg::OnBnClickedHandwinput)
	ON_BN_CLICKED(IDB_PICTINPUT, &CSUDOKUMFCDlg::OnBnClickedPictinput)
//	ON_EN_SETFOCUS(IDC_ECI9, &CSUDOKUMFCDlg::OnEnSetfocusEci9)
ON_EN_KILLFOCUS(IDC_ECI9, &CSUDOKUMFCDlg::OnEnKillfocusEci9)
ON_EN_KILLFOCUS(IDC_ECA1, &CSUDOKUMFCDlg::OnEnKillfocusEca1)
ON_EN_KILLFOCUS(IDC_ECA2, &CSUDOKUMFCDlg::OnEnKillfocusEca2)
ON_EN_KILLFOCUS(IDC_ECA3, &CSUDOKUMFCDlg::OnEnKillfocusEca3)
ON_EN_KILLFOCUS(IDC_ECA4, &CSUDOKUMFCDlg::OnEnKillfocusEca4)
ON_EN_KILLFOCUS(IDC_ECA5, &CSUDOKUMFCDlg::OnEnKillfocusEca5)
ON_EN_KILLFOCUS(IDC_ECA6, &CSUDOKUMFCDlg::OnEnKillfocusEca6)
ON_EN_KILLFOCUS(IDC_ECA7, &CSUDOKUMFCDlg::OnEnKillfocusEca7)
ON_EN_KILLFOCUS(IDC_ECA8, &CSUDOKUMFCDlg::OnEnKillfocusEca8)
ON_EN_KILLFOCUS(IDC_ECA9, &CSUDOKUMFCDlg::OnEnKillfocusEca9)
ON_EN_KILLFOCUS(IDC_ECB1, &CSUDOKUMFCDlg::OnEnKillfocusEcb1)
ON_EN_KILLFOCUS(IDC_ECB2, &CSUDOKUMFCDlg::OnEnKillfocusEcb2)
ON_EN_KILLFOCUS(IDC_ECB3, &CSUDOKUMFCDlg::OnEnKillfocusEcb3)
ON_EN_KILLFOCUS(IDC_ECB4, &CSUDOKUMFCDlg::OnEnKillfocusEcb4)
ON_EN_KILLFOCUS(IDC_ECB5, &CSUDOKUMFCDlg::OnEnKillfocusEcb5)
ON_EN_KILLFOCUS(IDC_ECB6, &CSUDOKUMFCDlg::OnEnKillfocusEcb6)
ON_EN_KILLFOCUS(IDC_ECB7, &CSUDOKUMFCDlg::OnEnKillfocusEcb7)
ON_EN_KILLFOCUS(IDC_ECB8, &CSUDOKUMFCDlg::OnEnKillfocusEcb8)
ON_EN_KILLFOCUS(IDC_ECB9, &CSUDOKUMFCDlg::OnEnKillfocusEcb9)
ON_EN_KILLFOCUS(IDC_ECC1, &CSUDOKUMFCDlg::OnEnKillfocusEcc1)
ON_EN_KILLFOCUS(IDC_ECC2, &CSUDOKUMFCDlg::OnEnKillfocusEcc2)
ON_EN_KILLFOCUS(IDC_ECC3, &CSUDOKUMFCDlg::OnEnKillfocusEcc3)
ON_EN_KILLFOCUS(IDC_ECC4, &CSUDOKUMFCDlg::OnEnKillfocusEcc4)
ON_EN_KILLFOCUS(IDC_ECC5, &CSUDOKUMFCDlg::OnEnKillfocusEcc5)
ON_EN_KILLFOCUS(IDC_ECC6, &CSUDOKUMFCDlg::OnEnKillfocusEcc6)
ON_EN_KILLFOCUS(IDC_ECC7, &CSUDOKUMFCDlg::OnEnKillfocusEcc7)
ON_EN_KILLFOCUS(IDC_ECC8, &CSUDOKUMFCDlg::OnEnKillfocusEcc8)
ON_EN_KILLFOCUS(IDC_ECC9, &CSUDOKUMFCDlg::OnEnKillfocusEcc9)
ON_EN_KILLFOCUS(IDC_ECD1, &CSUDOKUMFCDlg::OnEnKillfocusEcd1)
ON_EN_KILLFOCUS(IDC_ECD2, &CSUDOKUMFCDlg::OnEnKillfocusEcd2)
ON_EN_KILLFOCUS(IDC_ECD3, &CSUDOKUMFCDlg::OnEnKillfocusEcd3)
ON_EN_KILLFOCUS(IDC_ECD4, &CSUDOKUMFCDlg::OnEnKillfocusEcd4)
ON_EN_KILLFOCUS(IDC_ECD5, &CSUDOKUMFCDlg::OnEnKillfocusEcd5)
ON_EN_KILLFOCUS(IDC_ECD6, &CSUDOKUMFCDlg::OnEnKillfocusEcd6)
ON_EN_KILLFOCUS(IDC_ECD7, &CSUDOKUMFCDlg::OnEnKillfocusEcd7)
ON_EN_KILLFOCUS(IDC_ECD8, &CSUDOKUMFCDlg::OnEnKillfocusEcd8)
ON_EN_KILLFOCUS(IDC_ECD9, &CSUDOKUMFCDlg::OnEnKillfocusEcd9)
ON_EN_KILLFOCUS(IDC_ECE1, &CSUDOKUMFCDlg::OnEnKillfocusEce1)
ON_EN_KILLFOCUS(IDC_ECE2, &CSUDOKUMFCDlg::OnEnKillfocusEce2)
ON_EN_KILLFOCUS(IDC_ECE3, &CSUDOKUMFCDlg::OnEnKillfocusEce3)
ON_EN_KILLFOCUS(IDC_ECE4, &CSUDOKUMFCDlg::OnEnKillfocusEce4)
ON_EN_KILLFOCUS(IDC_ECE5, &CSUDOKUMFCDlg::OnEnKillfocusEce5)
ON_EN_KILLFOCUS(IDC_ECE6, &CSUDOKUMFCDlg::OnEnKillfocusEce6)
ON_EN_KILLFOCUS(IDC_ECE7, &CSUDOKUMFCDlg::OnEnKillfocusEce7)
ON_EN_KILLFOCUS(IDC_ECE8, &CSUDOKUMFCDlg::OnEnKillfocusEce8)
ON_EN_KILLFOCUS(IDC_ECE9, &CSUDOKUMFCDlg::OnEnKillfocusEce9)
ON_EN_KILLFOCUS(IDC_ECF1, &CSUDOKUMFCDlg::OnEnKillfocusEcf1)
ON_EN_KILLFOCUS(IDC_ECF2, &CSUDOKUMFCDlg::OnEnKillfocusEcf2)
ON_EN_KILLFOCUS(IDC_ECF3, &CSUDOKUMFCDlg::OnEnKillfocusEcf3)
ON_EN_KILLFOCUS(IDC_ECF4, &CSUDOKUMFCDlg::OnEnKillfocusEcf4)
ON_EN_KILLFOCUS(IDC_ECF5, &CSUDOKUMFCDlg::OnEnKillfocusEcf5)
ON_EN_KILLFOCUS(IDC_ECF6, &CSUDOKUMFCDlg::OnEnKillfocusEcf6)
ON_EN_KILLFOCUS(IDC_ECF7, &CSUDOKUMFCDlg::OnEnKillfocusEcf7)
ON_EN_KILLFOCUS(IDC_ECF8, &CSUDOKUMFCDlg::OnEnKillfocusEcf8)
ON_EN_KILLFOCUS(IDC_ECF9, &CSUDOKUMFCDlg::OnEnKillfocusEcf9)
ON_EN_KILLFOCUS(IDC_ECG1, &CSUDOKUMFCDlg::OnEnKillfocusEcg1)
ON_EN_KILLFOCUS(IDC_ECG2, &CSUDOKUMFCDlg::OnEnKillfocusEcg2)
ON_EN_KILLFOCUS(IDC_ECG3, &CSUDOKUMFCDlg::OnEnKillfocusEcg3)
ON_EN_KILLFOCUS(IDC_ECG4, &CSUDOKUMFCDlg::OnEnKillfocusEcg4)
ON_EN_KILLFOCUS(IDC_ECG5, &CSUDOKUMFCDlg::OnEnKillfocusEcg5)
ON_EN_KILLFOCUS(IDC_ECG6, &CSUDOKUMFCDlg::OnEnKillfocusEcg6)
ON_EN_KILLFOCUS(IDC_ECG7, &CSUDOKUMFCDlg::OnEnKillfocusEcg7)
ON_EN_KILLFOCUS(IDC_ECG8, &CSUDOKUMFCDlg::OnEnKillfocusEcg8)
ON_EN_KILLFOCUS(IDC_ECG9, &CSUDOKUMFCDlg::OnEnKillfocusEcg9)
ON_EN_KILLFOCUS(IDC_ECH1, &CSUDOKUMFCDlg::OnEnKillfocusEch1)
ON_EN_KILLFOCUS(IDC_ECH2, &CSUDOKUMFCDlg::OnEnKillfocusEch2)
ON_EN_KILLFOCUS(IDC_ECH3, &CSUDOKUMFCDlg::OnEnKillfocusEch3)
ON_EN_KILLFOCUS(IDC_ECH4, &CSUDOKUMFCDlg::OnEnKillfocusEch4)
ON_EN_KILLFOCUS(IDC_ECH5, &CSUDOKUMFCDlg::OnEnKillfocusEch5)
ON_EN_KILLFOCUS(IDC_ECH6, &CSUDOKUMFCDlg::OnEnKillfocusEch6)
ON_EN_KILLFOCUS(IDC_ECH7, &CSUDOKUMFCDlg::OnEnKillfocusEch7)
ON_EN_KILLFOCUS(IDC_ECH8, &CSUDOKUMFCDlg::OnEnKillfocusEch8)
ON_EN_KILLFOCUS(IDC_ECH9, &CSUDOKUMFCDlg::OnEnKillfocusEch9)
ON_EN_KILLFOCUS(IDC_ECI1, &CSUDOKUMFCDlg::OnEnKillfocusEci1)
ON_EN_KILLFOCUS(IDC_ECI2, &CSUDOKUMFCDlg::OnEnKillfocusEci2)
ON_EN_KILLFOCUS(IDC_ECI3, &CSUDOKUMFCDlg::OnEnKillfocusEci3)
ON_EN_KILLFOCUS(IDC_ECI4, &CSUDOKUMFCDlg::OnEnKillfocusEci4)
ON_EN_KILLFOCUS(IDC_ECI5, &CSUDOKUMFCDlg::OnEnKillfocusEci5)
ON_EN_KILLFOCUS(IDC_ECI6, &CSUDOKUMFCDlg::OnEnKillfocusEci6)
ON_EN_KILLFOCUS(IDC_ECI7, &CSUDOKUMFCDlg::OnEnKillfocusEci7)
ON_EN_KILLFOCUS(IDC_ECI8, &CSUDOKUMFCDlg::OnEnKillfocusEci8)
//ON_MESSAGE(WM_REDRAW, &CSUDOKUMFCDlg::OnRedraw)
ON_MESSAGE(WM_STARTDRAW, &CSUDOKUMFCDlg::OnStartdraw)
//ON_MESSAGE(WM_BRUSHSPIN, &CSUDOKUMFCDlg::OnBrushspin)
//ON_MESSAGE(WM_IMAGESTORE, &CSUDOKUMFCDlg::OnImagestore)
ON_MESSAGE(WM_STARTCLASSIFY, &CSUDOKUMFCDlg::OnStartclassify)
//ON_MESSAGE(WM_QUITDRAW, &CSUDOKUMFCDlg::OnQuitdraw)
ON_MESSAGE(WM_BRUSHSPINN, &CSUDOKUMFCDlg::OnBrushspinn)
ON_MESSAGE(WM_SUBWIN1CLOSE, &CSUDOKUMFCDlg::OnSubwin1close)
ON_MESSAGE(WM_QUITDRAW, &CSUDOKUMFCDlg::OnQuitdraw)
END_MESSAGE_MAP()
...
void CSUDOKUMFCDlg::OnBnClickedProsolve()
{
	...
	m_ImageInput.EnableWindow(TRUE);
...
{   
	...
	m_ImageInput.EnableWindow(FALSE);
	m_HandWInput.EnableWindow(FALSE);
	m_PictInput.EnableWindow(FALSE);
	//第二模块
...
void CSUDOKUMFCDlg::OnBnClickedImageinput()
{
	// TODO: 在此添加控件通知处理程序代码

	InitInputCheckBoxStatus();

	m_HandWInput.EnableWindow(TRUE);
	m_PictInput.EnableWindow(TRUE);
...
void CSUDOKUMFCDlg::OnBnClickedHandwinput()
{
	// TODO: 在此添加控件通知处理程序代码

	// 如果指针变量m_HWIDlg的值为NULL，则对话框还未创建，需要动态创建   
    if (NULL == m_pHandWDlg)   
    {   
        // 创建非模态对话框实例   
        m_pHandWDlg = new CHandWDlg();   
        m_pHandWDlg->Create(IDD_DIALOG3, this);   
    }   
    // 显示非模态对话框   
    m_pHandWDlg->ShowWindow(SW_SHOW);  
...
void CSUDOKUMFCDlg::OnBnClickedPictinput()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	for(int i = 0 ; i < 9 ; i++)
	{
		for(int j = 0 ; j < 9 ; j++)
		{
			SetDlgItemInt((*(SUDOKUmap[i][j])).GetDlgCtrlID(), PictSUDOKU[i][j]);
		}
	}
}
...
int CSUDOKUMFCDlg::CreateBoard()
{
    ...
    for(;;) {
		...
		//scanf("%s", &c);
		if(bHandWOrPict == true)
		{
			if( (char) cccccc == 27 ) {cccccc = 0 ;	break;}
			if( (char) cccccc == '+' ) { r ++; drawCursor(last_x, last_y); }
			if( ((char)cccccc == '-') && (r>1) ) { r--; drawCursor(last_x, last_y); }
			if( (char)cccccc == 'r') { 
				cvSet(imagen, cvRealScalar(255),NULL);
				cvSetMouseCallback("Demo", &on_mouse, 0 );
				//drawCursor(last_x, last_y);
			}
			if( (char)cccccc == 's') cvSaveImage("out.png", imagen);
			if( (char)cccccc == 'c') 
			{
				ocr.classify(imagen, 1, 2);
				int mm = 0;
				for(int p = 0 ; p < 10 ; p++)
				{
					if(Weights[mm].p < Weights[p].p)	mm = p;
				}
				SetDlgItemInt((*(SUDOKUmap[CurrentBlankPos[0]][CurrentBlankPos[1]])).GetDlgCtrlID(), mm);
			}
			//if( (char)c == 'b') cut();
			if( (char)cccccc == 'y') {
				IplImage *prs = cvLoadImage("test.jpg", CV_LOAD_IMAGE_UNCHANGED);
				ocr.classify(prs, 1, 2);
			}
		}
		cccccc = 0;
    }
...
//void CSUDOKUMFCDlg::OnEnSetfocusEci9()
//{
//	// TODO: 在此添加控件通知处理程序代码
//
//	
...
void CSUDOKUMFCDlg::OnEnKillfocusEci9()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEca1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEca2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEca3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEca4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEca5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEca6()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEca7()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEca8()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEca9()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcb1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcb2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcb3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcb4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcb5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcb6()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcb7()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcb8()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcb9()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcc1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcc2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcc3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcc4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcc5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcc6()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcc7()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcc8()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcc9()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcd1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcd2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcd3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcd4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcd5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcd6()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcd7()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcd8()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcd9()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEce1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEce2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEce3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEce4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEce5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEce6()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEce7()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEce8()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEce9()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcf1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcf2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcf3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcf4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcf5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcf6()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcf7()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcf8()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcf9()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcg1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcg2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcg3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcg4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcg5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcg6()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcg7()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcg8()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEcg9()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEch1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEch2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEch3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEch4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEch5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEch6()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEch7()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEch8()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEch9()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEci1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEci2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEci3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEci4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEci5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEci6()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEci7()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CSUDOKUMFCDlg::OnEnKillfocusEci8()
{
	// TODO: 在此添加控件通知处理程序代码
...
//afx_msg LRESULT CSUDOKUMFCDlg::OnRedraw(WPARAM wParam, LPARAM lParam)
//{
//	SetDlgItemInt((*(SUDOKUmap[0][0])).GetDlgCtrlID(), 9);
//	return 0;
//}


afx_msg LRESULT CSUDOKUMFCDlg::OnStartdraw(WPARAM wParam, LPARAM lParam)
{
	cccccc = (char)'r';
	return 0;
}
...
afx_msg LRESULT CSUDOKUMFCDlg::OnBrushspin(WPARAM wParam, LPARAM lParam)
{
	cccccc = (char)'-';
	return 0;
}
...
afx_msg LRESULT CSUDOKUMFCDlg::OnImagestore(WPARAM wParam, LPARAM lParam)
{
	cccccc = (char)'s';
	return 0;
}
...
afx_msg LRESULT CSUDOKUMFCDlg::OnStartclassify(WPARAM wParam, LPARAM lParam)
{
	cccccc = (char)'c';
	return 0;
}
...
afx_msg LRESULT CSUDOKUMFCDlg::OnQuitdraw(WPARAM wParam, LPARAM lParam)
{
	cccccc = 27;
	return 0;
}
...
afx_msg LRESULT CSUDOKUMFCDlg::OnBrushspinn(WPARAM wParam, LPARAM lParam)
{
	cccccc = (char)'+';
	return 0;
}
...
afx_msg LRESULT CSUDOKUMFCDlg::OnSubwin1close(WPARAM wParam, LPARAM lParam)
{
	m_pHandWDlg->CloseWindow();  
	//m_pHandWDlg->DestoryWindow();  
	return 0;
}
